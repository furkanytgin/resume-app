        ...
        @endif
            ...
            <div class="col mb-4">
              <div class="form-outline">
                ...
                <input type="text" id="form6Example1" class="form-control" name="title" value="{{  $resume->title }}"/>
              </div>
            </div>
            ...
            <div class="col mb-4">
                <div class="form-outline">
                  ...
                  <input type="text" id="form6Example2" class="form-control" name="summary" value="{{ $resume->summary }}" />
                </div>
              </div>
            ...
            <div class="col mb-4">
                <div class="form-outline">
                  ...
                  <input type="text" id="form6Example2" class="form-control" name="skills" value="{{ $resume->skills }}" />
                </div>
              </div>
              ...
              <div class="col mb-4">
                <div class="form-outline">
                  ...
                  <input type="text" id="form6Example2" class="form-control" name="education" value="{{ $resume->education }}" />
                </div>
              </div>
              ...
              <div class="col">
                <div class="form-outline">
                  ...
                  <input type="text" id="form6Example2" class="form-control" name="experience" value="{{ $resume->experience }}" />
                </div>
              </div>
              ...
              <div class="col">
                <div class="form-outline">
                  ...
                  <input type="text" id="form6Example2" class="form-control" name="interest" value="{{ $resume->interest }}" />
                </div>
              </div>
                ...
                <div class="col-md-6 mt-4">
                    <select class="form-select form-select-lg mb-3" name="theme" id="section" onchange="showImage()">
                        ...
                        @foreach (App\Enums\CvBlade::cases() as $blade)
                            <option value="{{ $blade->value }}" @selected($resume->theme == $blade->value)>{{ $blade->name }}</option>
                        @endforeach
                      </select>
                </div>
